...
const OrderInfo = ({icon, title, subTitle, text, success, danger}) => {
    return(
        ...
        py={2}
         ...
         px={4}
         >
            <Center bg="#ef837b" w={60} h={60} rounded="full" >
                {icon}
...
{success &&(
    <Center py={2} mt={2} rounded={5} w="full" bg={Colors.blue}>
        <Text fontSize={12} color={Colors.white} >PAGO EL 19 DIC 2022</Text>
</Center>

)}
{danger &&(
    <Center py={2} mt={2} rounded={5} w="full" bg={Colors.red}>
        <Text fontSize={12} color={Colors.white} >NO ENTREGADO</Text>
</Center>
